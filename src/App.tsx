    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/80 backdrop-blur-md border-b border-apple-gray-100 py-3' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tighter">MoreGuests.com</span>
        </div>
      ...
      <footer className="py-12 border-t border-apple-gray-100 text-center">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm tracking-tighter">MoreGuests.com</span>
          </div>
          <p className="text-xs text-apple-gray-300">© 2026 MoreGuests.com. All rights reserved. Built for Independent Resort Owners.</p>
